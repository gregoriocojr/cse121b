...
// * Activity 1 * //
// function displayArrayWithForEach (favoriteFoods) {
//     let favFood = document.querySelector('#favorite-foods');

//     favoriteFoods.forEach(function(item) {
//         let food = document.createElement('li');

//         food.textContent = item;

//         favFood.appendChild(food);
//     });
// }

function displayArrayWithMap (favoriteFoods) {
    let favFood = document.querySelector('#favorite-food');

    let foods = favoriteFoods.map(function(item) {
        let food = document.createElement('li');
