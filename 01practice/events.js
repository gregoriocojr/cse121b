...
function renderTasks(tasks) {
  ...
  // loop through the tasks array. for each of them we need 
  // to add the HTML markup for a todo.
...
// call the 'newTask' function on submit and call the 'manageTasks' function if either of the 
// icons are clicked in the list of tasks.
